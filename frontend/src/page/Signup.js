...
import signuplogo from '../assets/avatar.png'
...
const Signup = () => {
  ...
  return (
    ...
    <div className='p-3 md:p-4 background-container'>
        <div className='w-full max-w-sm bg-white m-auto rounded-lg flex  flex-col p-2'>
            {/* <h1 className='text-center text-2xl font-bold'>Sign Up</h1> */}
            <div className='w-20 h-20 overflow-hidden rounded-full drop-shadow-md shadow-md m-auto relative cursor-pointer'>
                <img src={data.image ? data.image : signuplogo} className='w-full h-full'/>
            ...
            <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
                ...
                <button type='submit' className='w-full max-w-[150px] m-auto  bg-blue-500 hover:bg-red-500 font-bold cursor-pointer text-white text-xl text-center py-1 rounded-full mt-4'>Sign UP</button>
            </form>
            <p className='text-left text-sm mt-2'>Already have an account ? <Link to={"/login"} className='text-black-500 underline hover:text-red-500'>Login</Link></p>
        </div>
    </div>
  )
}
